  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50/50 overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center text-white bg-slate-900">
        {/* Gradient Mesh */}
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-[#0f172a] to-[#1e293b]" />

        {/* Particles */}
        <LoginParticles />

        {/* Soft Ambient Glows (Subtle) */}
        <div className="absolute top-[-20%] right-[-20%] w-[800px] h-[800px] bg-blue-500/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-20%] left-[-20%] w-[800px] h-[800px] bg-emerald-500/05 rounded-full blur-[120px]" />
