...
"[project]/404SquadSolarConnect/final/app/api/agreements/[id]/sign/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function resolveInstallerUserIds(organizationId) {
    if (!organizationId) return [];
    const users = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
        where: {
            organizationId,
            role: "installer",
...
async function GET(request, context) {
    ...
    const agreement = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].agreement.findUnique({
        where: {
            id
        }
    });
    if (!agreement) return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Agreement not found"
    }, {
        status: 404
    });
    const dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: user.id
        },
        select: {
...
async function PATCH(request, context) {
    ...
    if (user.role !== "customer" && user.role !== "installer") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Only customer or installer can sign"
        }, {
            status: 403
        });
    }
    ...
    if (!formData) return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    if (!file || typeof file === "string") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Signed agreement file is required"
        }, {
            status: 400
        });
    }
    const uploadsDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "uploads", "agreements");
    ...
    const fileName = file?.name ?? "signed.pdf";
    const ext = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].extname(fileName) || ".pdf";
    ...
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(uploadsDir, storedName), Buffer.from(arrayBuffer));
    const url = `/uploads/agreements/${storedName}`;
    const now = new Date();
    // 4. Update Agreement Status
    const agreementUpdate = user.role === "customer" ? {
        customerSignedUrl: url,
        customerSignedAt: now,
        status: "customer_signed"
    } : {
        installerSignedUrl: url,
        installerSignedAt: now,
        status: "installer_signed"
    };
    ...
    const appStatus = user.role === "customer" ? "customer_signed" : "installer_signed";
    ...
    if (user.role === "customer") {
        ...
        if (installerUserIds.length > 0) {
            await Promise.all(installerUserIds.map((uid)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAgreementNotification"])(uid, "Agreement signed by customer. Please sign and upload.", installerLink)));
        } else {
            console.warn(`[Agreement Sign] No active installer users found for Organization: ${agreement.installerOrganizationId}`);
        }
    } else {
        // Notify Customer
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAgreementNotification"])(agreement.customerId, "Agreement signed by installer. Please review/sign.", customerLink);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        agreement: updated
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2442666f._.js.map