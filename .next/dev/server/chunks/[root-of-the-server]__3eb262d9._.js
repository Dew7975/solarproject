...
"[project]/404SquadSolarConnect/final/app/api/notifications/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function PATCH(_, context) {
    ...
    const notification = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.findUnique({
        where: {
            id
        }
    });
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.update({
        where: {
            id
        },
        data: {
...
async function DELETE(_, context) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.delete({
        where: {
            id
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3eb262d9._.js.map