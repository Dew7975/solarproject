...
"[project]/404SquadSolarConnect/final/app/api/agreements/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function resolveInstallerUserId(organizationId) {
    if (!organizationId) return null;
    const installerUser = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findFirst({
        where: {
            organizationId,
            role: "installer"
        }
...
async function PATCH(request, context) {
    ...
    if (action === "send") {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAgreementNotification"])(agreement.customerId, "Your agreement is ready. Please sign and upload the signed copy.", customerLink);
        ...
        if (installerUserId) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAgreementNotification"])(installerUserId, "A customer agreement is ready. Please sign and upload the signed copy.", installerLink);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            agreement: updated
        });
    ...
    if (action === "approve") {
        ...
        try {
            ...
            const [updatedAgreement, , newCalibration] = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
                // 1. Approve Agreement
                __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].agreement.update({
                    where: {
                        id
                    },
                    data: {
                        officerApprovedAt: new Date(),
                        status: "officer_approved"
                    }
                }),
                // 2. Mark Application Complete
                __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.update({
                    where: {
                        id: agreement.applicationId
                    },
                    data: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].calibration.create({
                    data: {
            ...
            // Notifications
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAgreementNotification"])(agreement.customerId, "Your agreement has been approved by the officer. System is live.");
            const installerUserId = await resolveInstallerUserId(agreement.installerOrganizationId);
            if (installerUserId) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAgreementNotification"])(installerUserId, "The agreement has been approved by the officer. Installation complete.");
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee6e8670._.js.map