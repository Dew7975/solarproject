...
"[project]/404SquadSolarConnect/final/app/api/installers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        installers: organizations.map((org)=>{
            ...
            const visiblePackages = verified === "true" ? org.packages.filter((pkg)=>pkg.active) : org.packages;
            return {
                id: org.id,
...
async function POST(request) {
    ...
    try {
        const pkg = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].installerPackage.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05b2bd90._.js.map