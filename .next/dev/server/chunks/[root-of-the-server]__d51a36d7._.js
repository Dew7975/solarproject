...
"[project]/404SquadSolarConnect/final/app/api/payments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/* ------------------------------------------------------------------ */ /* Helpers                                                             */ /* ------------------------------------------------------------------ */ function mapInvoice(invoice) {
    return {
        id: invoice.id,
...
async function GET() {
    ...
    const now = new Date();
    await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoice.updateMany({
        where: {
            status: "pending",
            dueDate: {
                lt: now
    ...
    const [invoices, meterReadings] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoice.findMany({
            where,
            include: {
                application: {
                    select: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].meterReading.findMany({
            where: user.role === "officer" ? undefined : {
                application: {
                    customerId: user.id
                }
            }
    ...
    const monthlyBills = invoices.filter((inv)=>inv.type === "monthly_bill").map((inv)=>{
        const reading = meterReadings.find((r)=>r.applicationId === inv.applicationId && r.year === inv.dueDate.getFullYear() && r.month === inv.dueDate.getMonth() + 1);
        return {
            id: inv.id,
            invoiceId: inv.id,
...
async function POST(req) {
    ...
    const { invoiceId, amount, type, description } = body;
    if (!invoiceId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoice.update({
        where: {
            id: invoiceId
        },
        data: {
    ...
    if (!wasPaid && updated.type === "authority_fee" && updated.description === "Site visit fee" && updated.applicationId) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.update({
            ...
            data: {
                status: "site_visit_payment_completed"
            }
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendSiteVisitPaymentCompletedNotification"])(updated.applicationId, updated.id, updated.amount);
    }
    if (!wasPaid && updated.type === "installation" && updated.applicationId) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendInstallationPaymentCompletedNotification"])(updated.applicationId, updated.id, updated.amount);
    }
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendInvoicePaidNotification"])(updated.customerId, updated.id, updated.amount);
    return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        invoice: updated
    }, {
        status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d51a36d7._.js.map