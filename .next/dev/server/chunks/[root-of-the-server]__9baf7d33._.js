...
"[project]/404SquadSolarConnect/final/app/api/reviews/me/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function updateOrganizationRating(installerOrgId) {
    const agg = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.aggregate({
        where: {
            installerOrganizationId: installerOrgId
        },
        _avg: {
            rating: true
        },
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organization.update({
        where: {
            id: installerOrgId
        },
        data: {
...
async function GET(req) {
    try {
        ...
        const reviews = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.findMany({
            where: {
                installerOrganizationId: installerId
            },
            orderBy: {
                createdAt: "desc"
            },
        ...
        const stats = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.aggregate({
            where: {
                installerOrganizationId: installerId
            },
            _avg: {
...
async function POST(req) {
    try {
        ...
        if (user.role !== "customer") return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Forbidden"
        }, {
            status: 403
        });
        ...
        if (!applicationRef) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "applicationRef is required"
            }, {
                status: 400
            });
        }
        ...
        const app = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.findUnique({
            where: {
        ...
        if (!REVIEW_ALLOWED_STATUSES.includes(app.status)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Not allowed in status: ${app.status}`
            }, {
                status: 400
            });
        }
        if (!app.installerOrganizationId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Installer not assigned for this application"
            }, {
                status: 400
            });
        }
        // Upsert = create if first time, otherwise update (supports “edit later”)
        const review = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.upsert({
            where: {
            ...
            create: {
                ...
                installerOrganization: {
                    connect: {
                        id: app.installerOrganizationId
                    }
                }
            },
            update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9baf7d33._.js.map