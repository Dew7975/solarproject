...
"[project]/404SquadSolarConnect/final/app/api/officer/installers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function mapInstaller(org) {
    const primaryInstaller = org.users.find((user)=>user.role === "installer");
    return {
        id: org.id,
...
async function GET() {
    ...
    const organizations = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organization.findMany({
        include: {
            packages: true,
            users: true
        },
...
async function POST(request) {
    ...
    if (!installerId || !status) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "installerId and status are required"
        }, {
            status: 400
        });
    }
    const organization = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organization.findUnique({
        where: {
            id: installerId
        }
    });
    ...
    const updatedOrganization = await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].organization.update({
        where: {
            id: installerId
        },
        data: {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.updateMany({
        where: {
    ...
    const installerUsers = updatedOrganization.users.filter((orgUser)=>orgUser.role === "installer");
    await Promise.all(installerUsers.map((orgUser)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$lib$2f$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendInstallerVerificationNotification"])(orgUser.id, nextVerified ? "verified" : "rejected", nextRejected ? rejectionReason : undefined)));
    return __TURBOPACK__imported__module__$5b$project$5d2f$404SquadSolarConnect$2f$final$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        installer: mapInstaller(updatedOrganization)
    });
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__9d7a6621._.js.map